                            ...
                            <div className="chat_technical_message">
                                <div className={`${styles.message_block} ${styles.text_center} ${styles.text_center_col}`}>
                                    ...
                                    {visibleTestCancel_v2
                                        ...
                                        :
                                        <div className={styles.cancel_client_confirm}>
                                            <button>Подтвердить отмену заказа</button>
                                ...
                                <div className={styles.dispute_block}>
                                    ...
                                    {isCancelOrder_v4 || isDisputeArbitr ? null
                                       : <div className={styles.dispute_row}>
                                            <button className={styles.dispute_button} onClick={() => setVisibleCancelOrder_v4(true)}>Подтвердить отмену заказа</button>
                                            <button className={styles.dispute_button} onClick={() => setVisibleModalArbitation_v5(true)}>Обратиться в арбитраж</button>
                                        </div>
                                    }
