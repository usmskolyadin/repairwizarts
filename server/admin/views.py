...
from starlette_admin import StringField, IntegerField, BooleanField, EmailField, PasswordField, PhoneField,\
    HasOne, HasMany, EnumField, TimeField, DateTimeField, FloatField, TextAreaField, ListField
...
class ClientView(ModelView):
    fields = [
        ...
        StringField('avatar', 'Аватарка', display_template='/admin/display-image.html',
...
class MasterView(ModelView):
    fields = [
        ...
        ListField(StringField('pictures', label='Изображения', form_template='admin/input-image.html',
...
class FeedbackView(ModelView):
    ...
    async def validate(self, request: Request, data: Dict[str, Any]) -> None:
        try:
            ...
            entity_id = None
        data = await upload_file(data, 'pictures', 'submission_feedback', entity_id, True)
        return await super().validate(request, data)
...
class DeviceView(ModelView):
    fields = [
        'id',
        StringField('name', 'Название', required=True),
        StringField('picture', label='Изображениe', form_template='admin/input-image.html',
                    display_template='admin/display-image.html'),
...
class ArticleView(ModelView):
    fields = [
        ...
        StringField('cover_image', label='Обложка', form_template='admin/input-image.html',
                    display_template='admin/display-image.html'),
...
class MessageView(ModelView):
    fields = [
        ...
        ListField(StringField('files', 'Файлы', display_template='/admin/display-image.html',
...
class CoverPictureView(ModelView):
    fields = [
        'id',
        StringField('image', 'Изображение', display_template='/admin/display-image.html',
                    form_template='/admin/input-file.html', required=True)
    ]
...
class SettingsView(ModelView):
    fields = [
        FloatField('commission', 'Комиссия', placeholder='Комиссия в процентах %', required=True,
                   display_template='/admin/display-percentage.html', form_template='/admin/input-percentage.html')
    ]
