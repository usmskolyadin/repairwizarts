...
class ArticleService(AppService):
    ...
    def create_article_comment(self, article_id: int, data: ArticleCommentIn, client: models.user.Client)\
            -> ServiceResult:
    ...
    def dislike_comment(self, comment_id: int, user: models.user.Client) -> ServiceResult:
